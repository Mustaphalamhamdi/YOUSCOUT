...
@override
String toString() {
  return 'ProfileModel(userId: $userId, email: $email, displayName: $displayName, bio: $bio, position: $position, foot: $foot)';
}
...
class _ProfileModel implements ProfileModel {
  const _ProfileModel({required this.userId, required this.email, required this.displayName, this.bio, this.position, this.foot});
