...
@override
String toString() {
  return 'Profile(userId: $userId, email: $email, displayName: $displayName, bio: $bio, position: $position, foot: $foot)';
}
...
class _Profile implements Profile {
  const _Profile({required this.userId, required this.email, required this.displayName, this.bio, this.position, this.foot});
